...
const SlidingPanel = () => {
  ...
  const handleMove = (clientY: number) => {
    ...
    setPanelHeight(Math.min(80, Math.max(20, newHeight)));
  };
  ...
  return (
    <div
      ref={panelRef}
      className={`fixed bottom-0 left-0 right-0 z-50 w-full overflow-hidden rounded-t-xl bg-white shadow-md transition-transform duration-300 ease-in-out dark:bg-darkGray dark:shadow-xl ${
